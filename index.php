...
<head>
	...
	<center><title>Student Bank</title></center>
	<link rel = "stylesheet" type = "text/css" href = "buttons.css">
</head>

<body style="background:linear-gradient(to bottom ,black,	#614385,#614385,#614385,#614375,#516395);background-attachment: fixed;background-repeat: no-repeat;background-size: cover;">


<link rel = "stylesheet" type = "text/css" href = "style.css">


	<div class="one" style=" background-color:gray;
   height: :50px;
   width:100%;">
		<table width="1330">
...
<span style="color: #C1FFC1;">T</span>
<span style="color: #C1FFC1;">H</span>
<span style="color: #C1FFC1;">E</span>
...
<span style="color: #FFD700;">T</span>
<span style="color: #C1FFC1;">B</span>
<span style="color: #C1FFC1;">A</span>
<span style="color: #C1FFC1;">N</span>
<span style="color: #C1FFC1;">K</span>
</h1>
...
<div class="five">Designed By Rachana || As a part of THE SPARKS FOUNDATION internship.<br> Have any Query? Feel free to Contact:
</div>

      <span style="color: red; padding: 20px;">

          <br>        
         <a style="margin-left: 600px;color:wheat;" href="https://twitter.com/Neha_kumari_7" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-twitter fa-2x"></i></a>
         <a style="margin-left: 10px;color:wheat;"href="https://github.com/neha07kumari" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'" ><i class="fab fa-github fa-2x"></i></a>
         <a style="margin-left:10px;color:wheat;"href="https://www.linkedin.com/in/neha-kumari-09415a16b/" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-linkedin fa-2x"></i></a>
         <a style="margin-left: 10px;color:wheat;"href="https://www.instagram.com/neha7_kashyap/" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-instagram fa-2x"></i></a>
         </span> 
         </div>
</body>
</html>